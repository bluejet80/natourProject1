      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: 'http://192.168.1.138:3000/api/v1/users/login',
            data: {
              email: email,
              password: password
            }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: 'http://192.168.1.138:3000/api/v1/users/logout'
          });
        case 3:
          res = _context2.sent;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmx1ZWpldCIsImEiOiJjbGdyNGRqdzkwOWR1M2VyenlvMnE0Z2Q1In0.u5x4QvCXQKFR40LZ5JvcBg';
